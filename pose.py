...
class Pose(list):
    ...
    def drawPersonId(self, image):
        ...
        bottomLeftCornerOfText = (bottomLeftCornerOfText[0],bottomLeftCornerOfText[1]-3)
        fontScale = 0.3
        fontColor = (0, 255, 0)
        lineType = 1
    ...
    def drawBoundingBox(self, image, color):
        cv2.line(image, self.getBoundingBoxPoints.topLeft , self.getBoundingBoxPoints.bottomLeft, color=color, thickness=1)
        cv2.line(image, self.getBoundingBoxPoints.topLeft, self.getBoundingBoxPoints.topRight, color=color, thickness=1)
        cv2.line(image, self.getBoundingBoxPoints.topRight, self.getBoundingBoxPoints.bottomRight, color=color, thickness=1)
        cv2.line(image, self.getBoundingBoxPoints.bottomLeft, self.getBoundingBoxPoints.bottomRight, color=color, thickness=1)
